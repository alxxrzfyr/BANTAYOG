    ...
    <div>
      ...
      <div className="flex items-center overflow-hidden rounded-xl border border-gray-200 bg-white">
        ...
        <button
          type="button"
          onClick={increment}
          className="flex h-11 w-11 flex-shrink-0 items-center justify-center text-lg font-bold text-gray-500 transition-colors hover:bg-gray-100 active:bg-gray-200"
